...
Route::group(['prefix' => 'users'], function () {
    ...
    Route::post('/update-name', [UserController::class, 'updateName'])->middleware((['auth:api', "role:admin"]));
    Route::get('/search-by-name/{name}', [UserController::class, 'searchByName'])->middleware((['auth:api', "role:admin"]));
